...
export default function GestionGimnasioPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Gestion Gimnasio</h1>
        <p className="text-sm text-slate-400 mt-1">Administra clases, horarios y suscripciones del gimnasio</p>
      </div>
