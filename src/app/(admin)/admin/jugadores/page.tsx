...
export default function GestionJugadoresPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Gestion de Jugadores</h1>
        <p className="text-sm text-slate-400 mt-1">Fichas de jugadores, niveles y estadisticas</p>
      </div>
