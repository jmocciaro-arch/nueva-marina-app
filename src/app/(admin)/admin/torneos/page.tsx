...
export default function GestionTorneosPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Gestion de Torneos</h1>
        <p className="text-sm text-slate-400 mt-1">Crea y administra torneos, cuadros y resultados</p>
      </div>
